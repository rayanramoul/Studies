...
new Abonne(this.jTextField1.getText(),this.jTextField2.getText(),this.jTextField3.getText(),this.jPasswordField1.getText());        // TODO add your handling code here:
ListeAbonnes.listModel.removeAllElements();
for(int i=0;i<Abonne.nbrAbo;i++)
{
        ListeAbonnes.listModel.addElement(Abonne.abonnesS[i]);} ;
